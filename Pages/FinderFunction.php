...
<?php 
 while($row = $rs_result->fetch_assoc()) {
    ...
    echo "<tr class='$color'>";
      echo "<td style='color:blue; border-color: black'><a href=Edit.php?wo=".$row['WO_ID'].">Edit Ticket<br> #".$row['WO_ID']."<br>".$row['WO_STATUS']."</td>";
...
for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
            echo "<a href='/Pages/SearchWindow.php?page=".$i."'";
